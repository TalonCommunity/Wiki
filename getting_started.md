...
|(new!) sconv-b4                      | Beta         | Windows/macOS/Linux | A new beta model. Has notably better dictation than the default Talon model, but some issues. For example, it occasionally recongizes numbers spuriously.                | [link](/#new-sconv-b4-model) |
