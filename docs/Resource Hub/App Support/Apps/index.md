...
in this wiki. You will need to use one of the methods below to find this out.

Alternatively, there have been [cheatsheets](/docs/Resource%20Hub/talon_related_resources.md#odds-and-ends) generated by the community that may be of assistance.

## Using the help active command
...
The ones detailed here - `browser`, `navigation` and `tab` are directly linked to firefox voice commands.
