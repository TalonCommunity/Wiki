...
**Sound Tech GN-USB-2**: affordable, good quality, and has excellent voice isolation.

**Samson Q9u**: a step up from the Blue Yeti, but still affordable desktop mic that can be operated as either USB and XLR.
