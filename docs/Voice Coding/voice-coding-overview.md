...
By default, title tracking activates languages in supported applications such as Visual Studio Code, Visual Studio (requires a [plugin](https://marketplace.visualstudio.com/items?itemName=mayerwin.RenameVisualStudioWindowTitle) and [configuration](https://github.com/talonhub/community/blob/main/apps/visualstudio/visual_studio.py#L1-L2)), and Notepad++ by automatically using the extension of the active file to infer the active programming language.
